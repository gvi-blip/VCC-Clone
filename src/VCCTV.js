    ...
    <section className="vcctv">
      ...
      <div>
        ...
        <div className="text-content mts">
          <p>HEALTHCARE</p>
          <h1>
            How can we harness data for healthcare and safegaurd ourselves from
            cyber threats?
          </h1>
          <p>
            The global healthcare data is expected to grow at a CAGR of 36% by
            2025. To make healthcare more equitable, affordable and accessible,
            there is a need to find ways to unite and generate actionable
            insights from data. How collaborations and strategic partnerships
            can harness the data to tackle the issues faced by the sector?
          </p>
          <p>
